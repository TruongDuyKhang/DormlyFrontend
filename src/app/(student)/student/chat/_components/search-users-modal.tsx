// app/(student)/chat/_components/search-users-modal.tsx
'use client';
          ...
          >
            <div className="bg-gradient-to-r from-[#9d7443]/20 to-[#9d7443]/5 px-5 py-4 border-b border-white/40 shrink-0">
              ...
              <div className="flex items-center gap-2">
                <UserPlus className="h-5 w-5 text-[#9d7443]" />
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {user.studentId && <p className="text-xs text-stone-500">ID: {user.studentId}</p>}
                          {user.department && <p className="text-xs text-stone-500 truncate">{user.department}</p>}
                        </div>
                        ...
                        <div className="shrink-0">
                          {existingConv ? (
                            ...
                            <div className="rounded-full bg-[#9d7443]/20 p-2 opacity-0 group-hover:opacity-100 transition">
                              <MessageCircle className="h-4 w-4 text-[#9d7443]" />
                            </div>
                          )}
                        </div>
                      </button>
