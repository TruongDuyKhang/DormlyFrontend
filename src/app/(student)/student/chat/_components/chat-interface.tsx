// app/(student)/chat/_components/chat-interface.tsx
'use client';
...
import { conversations as initialConversations, currentUser, getMessagesForConversation, allUsers } from './mock-data';
...
export function ChatInterface() {
  ...
  if (!mounted) {
    return (
      <div className="relative flex h-[600px] w-full items-center justify-center overflow-hidden rounded-[2rem] border border-white/55 bg-[#ebe4d8] shadow-[0_30px_80px_-55px_rgba(38,35,31,0.72)]">
        <div className="h-8 w-8 animate-spin rounded-full border-2 border-stone-200 border-t-[#9d7443]" />
      </div>
    );
  }

  return (
    <div className="relative flex h-[600px] w-full overflow-hidden rounded-[2rem] border border-white/55 bg-[#ebe4d8] shadow-[0_30px_80px_-55px_rgba(38,35,31,0.72)]">
