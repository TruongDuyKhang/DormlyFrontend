// app/(platform)/residents/students/_components/BlocksView.tsx
'use client';
...
export function BlocksView({ blocks, hoveredBlockId, onHover, onSelect, getOccupancyColor }: BlocksViewProps) {
  return (
    <motion.div
