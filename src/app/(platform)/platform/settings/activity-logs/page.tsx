// app/(platform)/platform/settings/activity-logs/page.tsx
'use client';

import { useState } from 'react';
import { motion } from 'framer-motion';
import { Activity, Server, Download, History } from 'lucide-react';
import { ActivityLogsTab } from './_components/ActivityLogsTab';
import { SystemEventsTab } from './_components/SystemEventsTab';
import { cn } from '@/lib/utils';

type TabType = 'activities' | 'system';

export default function ActivityLogsPage() {
  const [activeTab, setActiveTab] = useState<TabType>('activities');

  const tabs = [
    { id: 'activities' as const, label: 'All Activities', description: 'User and system actions', icon: Activity },
    { id: 'system' as const, label: 'System Events', description: 'System-only events', icon: Server },
  ];
    ...
    <>
      ...
      >
        ...
        <div className="relative p-4 sm:p-6 2xl:p-7">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-stone-600">
                  Track who did what, when, and where in the system
                </p>
              </div>
            </div>
          </div>
          ...
          >
            {activeTab === 'activities' && <ActivityLogsTab />}
