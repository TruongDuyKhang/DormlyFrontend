// app/(platform)/operations/chat/_components/CreateGroupModal.tsx
'use client';
...
import { allUsers, currentUser } from './mockData';
              ...
              <div className="flex items-center gap-3 mt-2">
                <button
                  ...
                  className={cn(
                    ...
                    step === 'info' ? "text-[#c3a26c]" : "text-stone-400"
                  )}
                >
                  1. Group Info
                </button>
                ...
                <button
                  ...
                  className={cn(
                    "text-xs font-medium transition",
                    step === 'members' ? "text-[#c3a26c]" : "text-stone-400"
                  )}
                >
                  2. Add Members
                </button>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex justify-center">
                    <div className="relative">
                      <div className="flex h-24 w-24 items-center justify-center rounded-2xl bg-[#c3a26c]/20 text-[#c3a26c] overflow-hidden">
                        {groupAvatar ? (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-white/55 bg-white/40 px-4 py-2.5 text-sm text-stone-700 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-[#c3a26c]/30"
                      autoFocus
                    />
                  </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {member.studentId && (
                              <p className="text-xs text-stone-400 truncate">{member.studentId}</p>
                            )}
                          </div>
                          {isSelected && (
                            <Check className="h-5 w-5 text-[#c3a26c] shrink-0" />
                          )}
                        </button>
                      );
                    })}
