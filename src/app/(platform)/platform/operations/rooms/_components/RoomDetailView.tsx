// app/(platform)/operations/rooms/_components/RoomDetailView.tsx
'use client';

import { motion } from 'framer-motion';
import { ChevronLeft, Edit, Archive, UserPlus, User, GraduationCap, Calendar, ArrowRightLeft, UserMinus } from 'lucide-react';
        ...
        <div className="border-b border-white/30 px-6 py-4">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex gap-2">
              <button
                onClick={onEdit}
                className="rounded-xl border border-white/55 bg-white/40 px-4 py-2 text-sm font-medium text-stone-700 transition hover:bg-white/60 flex items-center gap-2"
              >
              ...
              <button
                onClick={onAssign}
                className="rounded-xl bg-[#c3a26c] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#b08f5a] flex items-center gap-2"
              >
